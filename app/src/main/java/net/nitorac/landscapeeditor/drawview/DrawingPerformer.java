...
import net.nitorac.landscapeeditor.drawview.brushes.BrushRenderer;
import net.nitorac.landscapeeditor.drawview.brushes.Brushes;
import net.nitorac.landscapeeditor.drawview.brushes.FillBrush;
import net.nitorac.landscapeeditor.drawview.brushes.PickBrush;
import net.nitorac.landscapeeditor.drawview.brushes.androidpathbrushes.Eraser;
import net.nitorac.landscapeeditor.drawview.brushes.androidpathbrushes.PathBrushRenderer;
import net.nitorac.landscapeeditor.drawview.brushes.stampbrushes.StampBrush;
import net.nitorac.landscapeeditor.drawview.brushes.stampbrushes.StampBrushRenderer;
...
class DrawingPerformer {
    ...
    public DrawingPerformer(DrawingView view, Brushes brushes){
    ...
    void onTouch(MotionEvent event) {
        ...
        if(action == MotionEvent.ACTION_UP && view.getBrushSettings().getSelectedBrush() == Brushes.FILL){
            ((FillBrush)mBrushes.getBrush(view.getBrushSettings().getSelectedBrush())).fillPoint(event.getX(), event.getY());
            return;
        }

        if (action == MotionEvent.ACTION_UP && view.getBrushSettings().getSelectedBrush() == Brushes.PICK) {
            ((PickBrush) mBrushes.getBrush(view.getBrushSettings().getSelectedBrush())).pickPoint(event.getX(), event.getY());
            return;
        }
